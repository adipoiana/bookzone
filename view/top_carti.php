...
// Verifică dacă s-a dat ID pentru produsul selectat

// Selectarea tuturor produselor din categoria selectată
$sql    = "SELECT * FROM produse p left join images i on p.id_produs=i.id_produs WHERE p.top_carti =1 AND i.main_image=1";
...
<div class="container-fluid body-detail">
    <div class="container breadcrumb-top">
        ...
        <a href="#cart" class="breadcrumbs__item">Cart</a> -->
            <a href="#" class="breadcrumbs__item is-active">Top carti</a>
        </nav>
    </div>
    <div class="container">
